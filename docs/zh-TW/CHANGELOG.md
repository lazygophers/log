...
我们欢迎贡献！请查看我们的 [贡献指南](/zh-TW/CONTRIBUTING) 了解以下详细信息：
...
对于安全漏洞，请查看我们的 [安全政策](/zh-TW/SECURITY) 了解：
...
本项目采用 MIT 许可证 - 查看 [LICENSE](/zh-TW/LICENSE) 文件了解详情。
