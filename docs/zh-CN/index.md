...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem', margin: '2rem 0' }}>
  ...
  />
  <LinkCard
    href="/zh-CN/CONTRIBUTING"
    title="贡献指南"
    description="如何为项目贡献代码"
  />
  <LinkCard
    href="/zh-CN/CODE_OF_CONDUCT"
    title="行为准则"
    description="社区行为规范"
  />
  <LinkCard
...
<div class="flex flex-wrap gap-4 mt-12">
  ...
  <a href="/zh-CN/" class="btn btn-primary">🇨🇳 简体中文</a>
  <a href="/zh-TW/" class="btn btn-secondary">🇹🇼 繁體中文</a>
</div>

## 📄 许可证

本项目采用 MIT 许可证 - 查看 <a href="/zh-CN/LICENSE">LICENSE</a> 文件了解详情。

## 🤝 贡献

我们欢迎贡献！请查看 <a href="/zh-CN/CONTRIBUTING">贡献指南</a> 了解详情。
